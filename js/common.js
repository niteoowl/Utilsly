    ...
    sidebarTools: [
        ...
        },
        {
            ...
            items: [
                ...
                { name: "Docker Compose 생성기", icon: "container", path: "/tools/dev/docker-compose" },
                { name: "Dockerfile 생성기", icon: "container", path: "/tools/dev/dockerfile" },
                { name: "반응형 화면 테스터", icon: "responsive_layout", path: "/tools/dev/responsive-tester" },
                { name: "내 IP 주소 확인", icon: "language", path: "/tools/dev/my-ip" },
            ]
        },
        {
            category: "파일 (File)",
            items: [
                ...
                { name: "메타데이터 수정기", icon: "edit_attributes", path: "/tools/file/metadata-editor" },
            ]
        },
        {
        ...
        },
        {
            ...
            items: [
                ...
                { name: "진수 변환기", icon: "123", path: "/tools/math/base-converter" },
