...
const Utilsly = {
    ...
    sidebarTools: [
        ...
        {
            category: "AI 도구 (WebGPU)",
            items: [
                { name: "AI 글쓰기 도우미", icon: "edit_note", path: "/tools/ai/writing-assistant" },
                { name: "AI 번역기", icon: "translate", path: "/tools/ai/translator" },
                { name: "스마트 배경 제거", icon: "auto_fix_high", path: "/tools/ai/background-remover" },
                { name: "AI 이미지 업스케일", icon: "HD", path: "/tools/ai/image-upscaler" },
                { name: "AI 챗봇", icon: "smart_toy", path: "/tools/ai/ai-chat" },
            ]
        }
    ],
