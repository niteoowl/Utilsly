...
Utilsly.i18n = {
    ...
    dictionary: {
        en: {
            ...
            "랜덤 (Random)": "Random Tools",
            "이미지 (Image)": "Image Tools",
            "비디오 (Video)": "Video Tools",
            "오디오 (Audio)": "Audio Tools",
            "메모/텍스트 (Memo)": "Memo & Text",
            "개발 (Dev)": "Developer Tools",
            "파일 (File)": "File Tools",
            "보안 (Security)": "Security Tools",
            "수학/계산 (Math)": "Math & Calc",
            "날짜/시간 (Date)": "Date & Time",
            "색상 도구 (Color)": "Color Tools",
            "건강 (Health)": "Health Tools",
            "금융/투자 (Finance)": "Finance Tools",
            "AI 도구 (Beta)": "AI Tools (Beta)",
            "사이드바 편집": "Edit Sidebar",
            "사다리 타기": "Ladder Game",
            "이미지 블러": "Image Blur",
            "특수문자 폰트": "Fancy Fonts",
            "글자 깨짐 복구": "Encoding Fixer",
            "비밀번호 생성기": "Password Generator",
            "PPT 암호 제거": "PPT Password Remover",
            "AI 챗봇": "AI Chatbot",
            "AI 글쓰기 도우미": "AI Writing Assistant",

            // Stopwatch & Timer & Date
            "랩": "Lap",
            "리셋": "Reset",
            "간편한 카운트다운 타이머입니다.": "A simple countdown timer.",
            "타이머 설정": "Set Timer",
            "시간 종료!": "Time is up!",
            "알림음 켜기": "Unmute",
            "알림음 끄기": "Mute",
            ...
            "시드니": "Sydney",
            "두바이": "Dubai",
            "협정 세계시 (UTC)": "Coordinated Universal Time (UTC)",
            "기념일 이름": "Event Name",
            "날짜 선택": "Select Date",
            "계산 기준": "Calculation Basis",
            "기준일 포함": "Include Start Date",
            "기준일 제외": "Exclude Start Date",
            "100일": "100 Days",
            "200일": "200 Days",
            "300일": "300 Days",
            "1주년": "1st Anniversary",
            ...
            "음력": "Lunar Calendar",
            "기준일": "Target Date",
            "오늘 기준": "Based on Today",
            "출생일 직접 입력": "Enter Birth Date",
            "요일": "Day of Week",

            // Random & Vote
            "후보 목록": "Candidate List",
            "한 줄에 하나씩 입력하세요": "Enter one per line",
            "추첨 인원": "Number of Winners",
            "명": "Person(s)",
            "중복 당첨 허용": "Allow Duplicate Winners",
            "추첨 하기": "Draw Winners",
            "당첨자": "Winner",
            "당첨자 발표": "Winners Announcement",
            "투표 주제": "Vote Topic",
            "투표 설정": "Vote Settings",
            "복수 선택 허용": "Allow Multiple Selections",
            "익명 투표": "Anonymous Vote",
            "투표 종료일": "End Date",
            "투표 하기": "Vote",
            "투표 결과": "Vote Results",
            "총 투표수": "Total Votes",
            "득표": "Votes",
            "비밀번호 생성 결과": "Generated Password",
            "비밀번호 길이": "Password Length",
            "소문자 포함": "Include Lowercase",
            "대문자 포함": "Include Uppercase",
            "숫자 포함": "Include Numbers",
            "특수문자 포함": "Include Symbols",
            "유사 문자 제외 (i, l, 1, L, o, 0, O)": "Exclude Similar Characters (i, l, 1, L, o, 0, O)",

            // Text & Dev
            "HTML 미리보기": "HTML Preview",
            "실시간 미리보기": "Real-time Preview",
            "새 창에서 열기": "Open in New Window",
            "코드 복사": "Copy Code",
            "템플릿": "Templates",
            ...
            "목록": "List",
            "폼": "Form",
            "QR 코드 내용": "QR Code Content",
            "이미지 크기": "Image Size",
            "오류 복원 레벨": "Error Correction Level",
            "낮음 (7%)": "Low (7%)",
            "중간 (15%)": "Medium (15%)",
            "높음 (25%)": "High (25%)",
            "최고 (30%)": "Highest (30%)",
            "JSON 데이터 입력": "Enter JSON Data",
            "TREE 보기": "Tree View",
            "RAW 보기": "Raw View",
            "압축하기": "Minify",
            "형식화": "Format",
            ...
            "잘못된 JSON 형식입니다.": "Invalid JSON format.",
            "CSV 데이터 입력": "Enter CSV Data",
            "구분자": "Delimiter",
            "쉼표 (,)": "Comma (,)",
            "탭 (\\t)": "Tab (\\t)",
            "세미콜론 (;)": "Semicolon (;)",
            ...
            "YAML 데이터 입력": "Enter YAML Data",
            "URL 입력": "Enter URL",
            "인코딩": "Encode",
            "디코딩": "Decode",
            "Base64 입력": "Enter Base64",
            "UUID 버전": "UUID Version",
            "개수": "Count",
            "생성된 UUID": "Generated UUID",
            "정규식 입력": "Enter Regex",
            "플래그": "Flags",
            "테스트 문자열": "Test String",
            "매칭 결과": "Match Results",
            "매칭된 그룹": "Matched Groups",
            ...
            "너비 (px)": "Width (px)",
            "높이 (px)": "Height (px)",
            "비율 고정": "Lock Aspect Ratio",
            "품질 (0-100)": "Quality (0-100)",
            ...
            "세금 (%)": "Tax (%)",
            "순수익": "Net Profit",
            "수익률": "Return on Investment (ROI)",
            "손익분기점": "Break-even Point",
            "원달러 환율": "KRW/USD Rate",
            "환율 계산": "Currency Calculation",
            "기준 통화": "Base Currency",
            "대상 통화": "Target Currency",
            "환율 정보가 없습니다.": "No exchange rate info available.",
